...
class AudioFourActivity : AppCompatActivity() {

    private val url = "http://working-staff.com/relaxSounds/birdsSound.mp3"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_audio_four)
