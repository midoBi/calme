...
class AudioThreeActivity : AppCompatActivity() {

    private val url = "http://working-staff.com/relaxSounds/fireSound.mp3"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_audio_three)
