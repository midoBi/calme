...
class AudioSevenActivity : AppCompatActivity() {

    private val url = "http://working-staff.com/relaxSounds/citySound.mp3"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_audio_seven)
