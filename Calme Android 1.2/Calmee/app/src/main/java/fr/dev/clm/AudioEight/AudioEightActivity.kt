...
class AudioEightActivity : AppCompatActivity() {

    private val url = "http://working-staff.com/relaxSounds/cikadiSound.mp3"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_audio_eight)
