...
class AudioOneActivity : AppCompatActivity() {

    private val url = "http://working-staff.com/relaxSounds/seaSound.mp3"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        shareButton.setOnClickListener {
            val s = ("Hello! Check this amazing relax audio file: http://working-staff.com/relaxSounds/seaSound.mp3")
