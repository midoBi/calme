...
class AudioSixActivity : AppCompatActivity() {

    private val url = "http://working-staff.com/relaxSounds/nightRainSound.mp3"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_audio_six)
