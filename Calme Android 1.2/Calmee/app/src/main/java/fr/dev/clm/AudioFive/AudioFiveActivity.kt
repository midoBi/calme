...
class AudioFiveActivity : AppCompatActivity() {

    private val url = "http://working-staff.com/relaxSounds/thunderSound.mp3"
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_audio_five)
